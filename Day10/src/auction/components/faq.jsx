...
//   };
    return(
        ...
        <div key={index} className="faq-ques">
          ...
          {faq.question}<div style={{marginTop: "-20px"}}><img style={{marginLeft: "800px", transform: `rotate(${rotationAngle}deg)`}} alt="" src="down-arrow.png" height="20px" width="20px"></img></div>
            {expanded === index && (
